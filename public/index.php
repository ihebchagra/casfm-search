    ...
    <body class="bg-slate-50">
        <div x-data="{
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-6">
                    <input type="text" x-model="searchTerm" @input.debounce="search" placeholder="Rechercher dans le document..." class="w-full px-4 py-2 rounded border border-indigo-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-serif">
                </div>
                <div class="space-y-4">
